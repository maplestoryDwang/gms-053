...
// */
//package net.sf.odinms.server.maps.reactor;
//
...
//import net.sf.odinms.server.quest.partyQuest.GuardianSpawnPoint;
//import net.sf.odinms.tools.Pair;
//import net.sf.odinms.tools.ReactorPacketCreator;
//
//import java.awt.*;
...
// */
//public class Reactor extends AbstractMapleMapObject {
...
//        return MapleMapObjectType.REACTOR;  // 返回对象类型为反应器
//    }
//
//    /**
//     * 获取反应器类型
...
//        client.getSession().write(makeDestroyData());  // 发送销毁数据包
//    }
//
//    /**
//     * 创建销毁数据包
//     * @return 数据包
//     */
//    public final MaplePacket makeDestroyData() {
//        return ReactorPacketCreator.destroyReactor(this);  // 生成反应器销毁包
//    }
//
//    @Override
//    public void sendSpawnData(MapleClient client) {
//        if (this.isAlive()) {
//            client.getSession().write(makeSpawnData());  // 如果存活则发送生成数据
//        }
//    }
//
//    /**
...
//     * @return 数据包
//     */
//    public final MaplePacket makeSpawnData() {
//        return ReactorPacketCreator.spawnReactor(this);  // 生成反应器生成包
//    }
//
//    /**
//     * 重置反应器动作
...
//            map.broadcastMessage(ReactorPacketCreator.triggerReactor(this, (short) 0));  // 广播触发消息
//        } finally {
...
//                                        } else {  // 正常触发
//                                            map.broadcastMessage(ReactorPacketCreator.triggerReactor(this, stance));  // 广播触发
//                                        }
//                                    } else {  // 最终步骤物品触发
//                                        map.broadcastMessage(ReactorPacketCreator.triggerReactor(this, stance));  // 广播触发
//                                    }
...
//        }
//
//        map.broadcastMessage(ReactorPacketCreator.destroyReactor(this));  // 广播销毁消息
//        return false;  // 返回失败
//    }
//
//    /**
